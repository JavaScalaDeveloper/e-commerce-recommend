package com.huat.huangjiahao.business.rest;

import com.huat.huangjiahao.business.model.domain.Product;
import com.huat.huangjiahao.business.model.recom.Recommendation;
import com.huat.huangjiahao.business.model.request.*;
import com.huat.huangjiahao.business.service.*;
import com.huat.huangjiahao.business.model.domain.User;
import com.huat.huangjiahao.business.utils.Constant;
import com.huat.huangjiahao.business.model.domain.Product;
import com.huat.huangjiahao.business.model.domain.User;
import com.huat.huangjiahao.business.model.recom.Recommendation;
import com.huat.huangjiahao.business.model.request.*;
import com.huat.huangjiahao.business.service.ProductService;
import com.huat.huangjiahao.business.service.RatingService;
import com.huat.huangjiahao.business.service.RecommenderService;
import com.huat.huangjiahao.business.service.UserService;
import com.huat.huangjiahao.business.utils.Constant;
...
public class ProductRestApi {
    ...
    @ResponseBody
    public Model rateToProduct(@PathVariable("id") int id, @RequestParam("score") Double score,
        ...
        //埋点日志
        if (complete)
            logger.info(Constant.PRODUCT_RATING_PREFIX + ":" + user.getUserId() + "|" + id + "|"
                    + request.getScore() + "|" + System.currentTimeMillis() / 1000);
        model.addAttribute("success", true);
    ...
    public Model getStreamProducts(@RequestParam("username") String username, @RequestParam("num") int num, Model model) {
        ...
        model.addAttribute("success", true);
        model.addAttribute("products", productService.getRecommendProducts(recommendations));
        if (recommendations.size() == 0) model = null;
        return model;
    }
}
